...
const displayBurgerMenu = () => {
	if (localStorage.getItem('dark-mode') === 'true') {
		if ($navbarList.classList.contains('hiddenMenu')) {
			...
			$burgerMenu.src = 'GIFOS_UI+Kit_Desktop+y+Mobile/GIFOS-UI-Desktop+Mobile-Update/assets/close-modo-noct.svg';
		} else {
		...
		if ($navbarList.classList.contains('hiddenMenu')) {
			$navbarList.classList.remove('hiddenMenu');
			$burgerMenu.src = 'GIFOS_UI+Kit_Desktop+y+Mobile/GIFOS-UI-Desktop+Mobile-Update/assets/close.svg';
		} else {
			$navbarList.classList.add('hiddenMenu');
			$burgerMenu.src = 'GIFOS_UI+Kit_Desktop+y+Mobile/GIFOS-UI-Desktop+Mobile-Update/assets/burger.svg';
		}
	}
};
...
$crearGifBtn.addEventListener('click', () => {
	$crearGifBtn.src = 'GIFOS_UI+Kit_Desktop+y+Mobile/GIFOS-UI-Desktop+Mobile-Update/assets/CTA-crear-gifo-active.svg';
});

$crearGifBtn.addEventListener('mouseover', () => {
	$crearGifBtn.src = 'GIFOS_UI+Kit_Desktop+y+Mobile/GIFOS-UI-Desktop+Mobile-Update/assets/CTA-crear-gifo-hover.svg';
});

$crearGifBtn.addEventListener('mouseout', () => {
	$crearGifBtn.src = 'GIFOS_UI+Kit_Desktop+y+Mobile/GIFOS-UI-Desktop+Mobile-Update/assets/button-crear-gifo.svg';
});
