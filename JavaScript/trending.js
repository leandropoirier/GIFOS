...
const setTrendingBtn = () => {
	if (localStorage.getItem('dark-mode') === 'true') {
		...
		$previousBtn.src = 'GIFOS_UI+Kit_Desktop+y+Mobile/GIFOS-UI-Desktop+Mobile-Update/assets/button-slider-left.svg';
		$nextBtn.src = 'GIFOS_UI+Kit_Desktop+y+Mobile/GIFOS-UI-Desktop+Mobile-Update/assets/Button-Slider-right.svg';
	}
};

$previousBtn.addEventListener('mouseover', () => {
	$previousBtn.src = 'GIFOS_UI+Kit_Desktop+y+Mobile/GIFOS-UI-Desktop+Mobile-Update/assets/button-slider-left-hover.svg';
});

$nextBtn.addEventListener('mouseover', () => {
	$nextBtn.src = 'GIFOS_UI+Kit_Desktop+y+Mobile/GIFOS-UI-Desktop+Mobile-Update/assets/Button-Slider-right-hover.svg';
});
