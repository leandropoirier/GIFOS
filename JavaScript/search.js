...
const displayErrorSearch = () => {
	...
	<img class="" id="error-search" src="GIFOS_UI+Kit_Desktop+y+Mobile/GIFOS-UI-Desktop+Mobile-Update/assets/icon-busqueda-sin-resultado.svg" alt="Busqueda sin resultado" >
...
const displaySuggestions = (suggestions) => {
	for (let i = 0; i < suggestions.data.length; i++) {
		...
		<img class="search__btnGray" id="" src="GIFOS_UI+Kit_Desktop+y+Mobile/GIFOS-UI-Desktop+Mobile-Update/assets/icon-search.svg" alt="Boton Buscar" onclick="getSearch('${suggestions.data[i].name}')">
